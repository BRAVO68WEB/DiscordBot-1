...
var config = { // NOTE: DO NOT LEAVE ANYTHING BLANK
	...
	ownerID: '457039372009865226', // Your ID here
	token: 'NTk5NTgyMzQxODExMjczNzM4.XZJwDg.B5OkLJcBCFwbzreMm0xKQuEoxeY', // Your bot token here
    ...
    googleAPIToken: 'AIzaSyDp7RzrgYK7oPoCI2bBtEcMPmaVbcLByN8', // Used for link shortener and music features. You need to have these APIs enabled.
	...
	dashboard: {
		...
		oauthSecret: 'SKyds3v6zvoT07jKko5Li8KornUvNlx8', // The client secret from the Discord bot page
		secure: 'false', // HTTPS: 'true' for true, 'false' for false
		sessionSecret: 'vrtv4tb4w3hw5hb76', // Go crazy on the keyboard here, this is used as a session secret
		domain: 'localhost:53134', // Domain name (with port if not running behind proxy running on port 80). Example: 'domain': 'dashboard.bot-website.com' OR 'domain': 'localhost:33445'
